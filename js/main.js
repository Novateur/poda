		...
		$('#assign_printer_form').submit(function(e){
			...
			{
				$('#paste_btn').html("<button type='button' onclick=\"cont_del_printer("+id+",'"+page+"')\">OK</button>");
			...
			{
				$('#paste_btn').html("<button type='button' onclick=\"cont_del_state("+id+","+page+")\">OK</button>");
				$('#delete_modal').openModal();
			}
			...
			function multi_del(page)
			{
				...
				$('#paste_btn_multi').html("<button type='button' onclick=\"cont_multi_del("+page+")\">OK</button>");
			}
			...
			{
				$('#multi_del_modal').openModal();
				$('#paste_btn_multi').html("<button type='button' onclick=\"cont_multi_del_cities("+page+")\">OK</button>");
			}
			...
			{
				$('#paste_btn').html("<button type='button' onclick=\"cont_del_city("+id+","+page+")\">OK</button>");
				$('#delete_modal').openModal();
			}
