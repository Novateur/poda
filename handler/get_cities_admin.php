<?php
	...
	if($query->rowCount() > 0)
	{
		...
		echo "<button type='button' id='delete_btn' style='display:none' onclick=\"multi_del_cities({$page})\">Delete</button>";
		...
		foreach($query as $r)
		{
			            echo "<tr>
                              ...
                              <td><button type='button' onclick=\"delete_city({$r['id']},{$page})\"><i class='fa fa-trash'></i></button></td>
                          </tr>";
		}
		echo "</tbody>";
		echo "</table>";
