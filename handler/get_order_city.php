							...
							echo "<div class='col s12'>";
								echo "<div align='center'id='paginate1'>";																
									...
									if($total_num_pages>1)
									{
										...
										if($previous>=1)
										{
											echo "<a href='#' onclick=\"paginate_city({$previous},{$id})\" data-role='button'>Previous</a> ";
										}
										for($i=1;$i<=$total_num_pages;$i++)
										{
											...
											{
												echo "<a href='#' onclick=\"paginate_city({$i},{$id})\" data-role='button'>{$i}</a> ";
											}
										}									
										if($next<=$total_num_pages)
										{
											echo "<a href='#' onclick=\"paginate_city({$next},{$id})\" data-role='button'>Next</a>";
										}
									}
								echo "</div>";
							echo "</div>";
