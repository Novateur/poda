...
<!--                        <li><a href="design.php">Design</a></li>-->
        ...
        <div class="container">
			<div class="row">    			
				...
				<div class="col s4">
					...
					<button type="button" id="search_btn" onclick="search_order()">Search</button>
				</div>
				<div class="col s4">
                ...
                <div class="modal-content">
                    ...
                    <p>
                        <form id="design_upload_form">
                            ...
                            <textarea rows="9" name="desc" id="desc" placeholder="Your brief description goes here..."></textarea>
      ...
      <script>
		...
		{
			$('#paste_btn').html("<button type='button' onclick=\"cont_del_order("+id+","+page+")\">Ok<button>");
			$('#delete_modal').openModal();
		}		
		function delete_orders_state(id,page,state)
		{
			$('#paste_btn').html("<button type='button' onclick=\"cont_del_order_state("+id+","+page+","+state+")\">Ok<button>");
			$('#delete_modal').openModal();
		}		
		function delete_orders_city(id,page,city)
		{
			$('#paste_btn').html("<button type='button' onclick=\"cont_del_order_city("+id+","+page+","+city+")\">Ok<button>");
			$('#delete_modal').openModal();
		}
